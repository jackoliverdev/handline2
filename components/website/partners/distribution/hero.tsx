        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-brand-dark dark:text-white font-heading">
              Distribute <span className="text-brand-primary">Hand Line</span> Products
            </h1>
          </motion.div>
          ...
          >
            <p className="max-w-2xl text-base md:text-lg text-brand-secondary dark:text-gray-300">
              Join our global distribution network to bring industry-leading safety solutions to your market. Our distributors benefit from exclusive products, competitive margins and comprehensive support.
            </p>
          </motion.div>
