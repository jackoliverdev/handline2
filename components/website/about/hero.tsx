...
import { Building, Users, Clock, Shield, Flag, ChevronRight, Mail } from "lucide-react";
...
export const AboutHero = () => {
  const { t } = useLanguage();
  const stats = [
    { value: '40+', label: t('about.stats.years') },
    { value: '65+', label: t('about.stats.team') },
    { value: '12', label: t('about.stats.countries') },
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex items-center rounded-full border border-brand-primary px-3 py-1 md:px-4 md:py-1.5 text-xs md:text-sm backdrop-blur-sm">
              <Flag className="mr-1.5 h-3 w-3 md:h-4 md:w-4 text-brand-primary" />
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-brand-dark dark:text-white font-heading">
              {t('about.heading')} <span className="text-brand-primary">HandLine</span>
            </h1>
          </motion.div>
          ...
          >
            <Button 
              ...
              asChild
            >
              <Link href="#our-story" className="flex items-center justify-center gap-1.5 md:gap-2">
