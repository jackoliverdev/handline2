...
export function RegulationsHero() {
  const { t } = useLanguage();
    ...
    <section className="relative overflow-hidden bg-[#F5EFE0]/80 dark:bg-transparent pt-28 pb-2 md:pt-32 md:pb-6">
      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={SPRING_CONFIG} className="mb-4 md:mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ ...SPRING_CONFIG, delay: 0.1 }} className="relative mb-4 md:mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ ...SPRING_CONFIG, delay: 0.2 }} className="mb-6 md:mb-8 space-y-3 md:space-y-4">
