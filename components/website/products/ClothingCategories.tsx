  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col items-center">
            ...
            >
              ...
              <span className="text-brand-dark dark:text-white font-medium font-heading">
                {t('products.categories.main.clothing.badge')}
              </span>
            </motion.div>
            <div className="inline-flex items-center justify-center mb-4">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-brand-dark dark:text-white font-heading">
                {t('products.categories.main.clothing.title')} Categories
              </h2>
              <motion.div 
                initial={{ width: 0 }}
                whileInView={{ width: "2.5rem" }}
            ...
            >
              {t('products.categories.main.clothing.categoriesDescription')}
            </motion.p>
          </div>
        </div>
        ...
        {/* Desktop / tablet grid */}
        <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 lg:gap-8 justify-center justify-items-center max-w-6xl mx-auto">
          {subcategories.map((subcategory, index) => (
            <CategoryCard
