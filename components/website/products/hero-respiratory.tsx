...
export const RespiratoryHero = () => {
  const { t } = useLanguage();
  const stats = [
    { value: t("respiratoryHero.stats.standardsValue"), label: t("respiratoryHero.stats.standards") },
    { value: t("respiratoryHero.stats.protection"), label: "Protection" },
    { value: "CE", label: t("respiratoryHero.stats.certified") },
    { value: "40+", label: t("respiratoryHero.stats.years") },
  ];
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-brand-dark dark:text-white font-heading">
              {t("respiratoryHero.heading")} <span className="text-brand-primary">{t("respiratoryHero.headingAccent")}</span>
            </h1>
          </motion.div>
          ...
          >
            ...
            >
              <Link href="#products" className="flex items-center justify-center gap-1.5 md:gap-2">
                ...
                <span>{t("respiratoryHero.browseProducts")}</span>
            ...
            >
              <Link href="/contact" className="flex items-center justify-center gap-1.5 md:gap-2">
                ...
                <span>{t("respiratoryHero.getInTouch")}</span>
                <ChevronRight className="h-3.5 w-3.5 md:h-4 md:w-4 transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
            </Button>
          </motion.div>
