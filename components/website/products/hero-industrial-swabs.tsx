...
export const IndustrialSwabsHero = () => {
  const { t } = useLanguage();
  const stats = [
    { value: t("industrialSwabsHero.stats.applicationsValue"), label: t("industrialSwabsHero.stats.applications") },
    { value: t("industrialSwabsHero.stats.precision"), label: "Precision" },
    { value: "CE", label: t("industrialSwabsHero.stats.certified") },
    { value: "40+", label: t("industrialSwabsHero.stats.years") },
  ];
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-brand-dark dark:text-white font-heading">
              {t("industrialSwabsHero.heading")} <span className="text-brand-primary">{t("industrialSwabsHero.headingAccent")}</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="max-w-2xl text-base md:text-lg text-brand-secondary dark:text-gray-300">
              {t("industrialSwabsHero.description")}
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <Link href="#products" className="flex items-center justify-center gap-1.5 md:gap-2">
                ...
                <span>{t("industrialSwabsHero.browseProducts")}</span>
            ...
            >
              <Link href="/contact" className="flex items-center justify-center gap-1.5 md:gap-2">
                ...
                <span>{t("industrialSwabsHero.getInTouch")}</span>
                <ChevronRight className="h-3.5 w-3.5 md:h-4 md:w-4 transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
            </Button>
          </motion.div>
