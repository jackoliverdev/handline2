        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-brand-dark dark:text-white font-heading">
              Compliance <span className="text-brand-primary">Declarations</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="max-w-2xl text-base md:text-lg text-brand-secondary dark:text-gray-300">
              Access official declarations of conformity for HandLine products. These documents certify that our products meet all the requirements of European health, safety, and environmental protection standards.
            </p>
          </motion.div>
