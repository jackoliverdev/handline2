    ...
    <section className="py-16 bg-[#F5EFE0]/80 dark:bg-transparent">
      <div className="container px-4 md:px-6">
        <div className="relative">
          ...
          >
            <Badge className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm mb-2 bg-brand-primary/10 text-brand-primary border border-brand-primary/20 hover:bg-brand-primary/10">
