...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[1000] p-4 md:p-5">
      <div className="mx-auto max-w-6xl rounded-xl border border-brand-primary/20 bg-white/90 backdrop-blur-md shadow-lg dark:bg-black/70 dark:border-brand-primary/30">
        <div className="flex flex-col gap-3 p-4 md:flex-row md:items-center md:justify-between">
          <div className="text-sm leading-5 text-brand-dark dark:text-gray-100 md:flex-1 md:pr-4">
            {t('cookies.message')}{' '}
